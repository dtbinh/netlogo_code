...
to setup
  ...
  [ set size 2         ;; easier to see
    set color green
    set starvation random-normal 6 2
    ;;    set starvation 2
    ]   ;; green = not carrying food
...
to go  ;; forever button
  ...
  [ if who >= ticks [ stop ] ;; delay initial departure
    ...
    ifelse color = green ;; is this the same color as when the ants were created???!
...
to look-for-food  ;; turtle procedure
  ...
  [ set color orange + 1     ;; pick up food
    set food food - 1        ;; and greenuce the food source
